...
from SketchHelperFunctions import create_constrained_line, join_lines, LineOrientation
...
if(mp.stator.IsInrunner == True):
	...
	lines = []
	lines.append(create_constrained_line(sketch, 
						App.Vector(mp.bottomBearing.OD - mp.bottomBearing.OuterRaceClearance,0),
						mp.BottomBearingSupportThickness,
	...
	lines.append(create_constrained_line(sketch, origin, mp.stator.StatorOD/2 - mp.stator.StatorODMountClearance, LineOrientation.HORIZONTAL))
	join_lines(sketch, lines[0], lines[1])
